...
<ol>
  ...
  <li></li>
  <li>Um denn Benchmark zu starten betätige den "Run current scene" Knopf.</li>
  <li></li>
  <li>Um denn Benchmark danach wieder zu schließen betätige den "Stop running Project" Knopf.</li>
  <li></li>
</ol>
